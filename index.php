...
<section class="section bg-default text-center offset-top-50">
  <div class="parallax-container" data-parallax-img="images/parallax-1-1920x850.jpg">
    <div class="parallax-content section-xl section-inset-custom-1 context-dark bg-overlay-2-21">
      <div class="container">
        <h2 class="heading-2 oh font-weight-normal wow slideInDown"><span class="d-block font-weight-semi-bold">Першокласні враження</span><span class="d-block font-weight-light">are Waiting for You!</span></h2>
        <p class="text-width-medium text-spacing-75 wow fadeInLeft" data-wow-delay=".1s">Наше агентство пропонує мандрівникам різноманітні тури та екскурсії з напрямками по всьій Україні. Перегляньте наш сайт, щоб знайти тур своєї мрії!</p><a class="button button-secondary button-pipaluk" href="#">Забронюйте тур зараз</a>
      </div>
    </div>
  </div>
</section>
